...
import Logica.LogicaList;

public class TrabCadaT extends JFrame {
	...
	public TrabCadaT() {
		...
		setTitle("Lista de Trabajadores Que tienen al menos un equipo en reparación de cada uno de los tipos de equipo que puede reparar ");
