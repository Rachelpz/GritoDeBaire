...
public class TrabTodosT extends JFrame {
	...
	public TrabTodosT() {
		...
		setTitle("Lista de Trabajadores Que pueden reparar todos los tipos de equipos.");
		//title.setText("Lista de Trabajadores");
		LinkedList<Trabajador>t=Taller.getSingletonInstance().puedenTipos();
